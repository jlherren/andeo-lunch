...
describe('Transaction', () => {
    ...
    describe('Transactions for lunch', () => {
        ...
        it('Two participants, one vegetarian', async () => {
            ...
            expect(response.body.transactions[1]).to.containSubset({
                eventId,
                userId:       user1.id,
                contraUserId: systemUser.id,
                date:         EVENT_DATE_1,
            ...
            expect(response.body.transactions[2]).to.containSubset({
                eventId,
                userId:       user1.id,
                contraUserId: systemUser.id,
                date:         EVENT_DATE_1,
    ...
    describe('Lunch with participation fee', () => {
        ...
        it('Fee is paid by all participants', async () => {
            ...
            expect(response.body.transactions[3]).to.containSubset({
                userId:       user1.id,
                contraUserId: systemUser.id,
                currency:     'money',
                amount:       -15,
